...
<html lang="en">
	<head>
		<title>FMS | View Flexible Heads</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<div class="container-fluid mt-5">
			<div class="row px-5 mx-5">
				<table class="table table-bordered table-striped mt-3 bg-white table-sm">
					<caption class="lead">List of flexible heads applied on different students of the school.</caption>
