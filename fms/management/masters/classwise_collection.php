...
if (isset($_SESSION['userid']) && ($_SESSION['userstatus'] == 'MANAGEMENT')) {
	...
	$navBrand = "Classwise Fee Collection";
	$result = $con->query("SELECT SUM(ACTUAL_PAID_AMOUNT), CLASS_SESSION_ID FROM receipts GROUP BY CLASS_SESSION_ID;");
?>

<!doctype html>
<html lang="en">
	<head>
		<title>FMS | Classwise Fee Collection</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<div class="container-fluid mt-5">
			<div class="row px-5 mx-5">
				<table class="table table-bordered table-striped mt-3 bg-white table-sm">
					<caption class="lead">Classwise fee collection details.</caption>
