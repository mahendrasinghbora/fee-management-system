		...
		<div class="container-fluid px-5">
			<div class="row pt-5">
				...
				<div class="col-lg-4 ml-sm-auto">
					<h3 class="form-banner" style="background-color: #2C9676;">Add Users</h3>
					<form class="form px-3 py-3" action="../php/submit_users.php" method="post">
						<div class="form-group">
							<label for="userID">User ID</label>
							<input type="text" class="form-control" id="userId" name="userId" aria-describedby="userIdHelp" placeholder="Enter user ID" required>
							<small id="userIdHelp" class="form-text text-muted sr-only">A user ID must be unique. Users will access their accounts using their uesr IDs.</small>
						</div>
						<div class="form-group">
