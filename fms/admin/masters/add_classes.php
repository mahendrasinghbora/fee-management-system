...
if (isset($_SESSION['userid']) && ($_SESSION['userstatus'] == 'ADMIN')) {
	...
	$navBrand = 'Add Classes';
?>

<!doctype html>
<html lang="en">
	<head>
		<title>FMS | Add Classes</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<div class="container-fluid px-5">
			<div class="row pt-5">
				...
				<div class="col-lg-4 ml-sm-auto mt-4">
					<h3 class="form-banner" style="background-color: #53BBB4;">Add Classes</h3>
					<form class="form px-3 py-3" action="../php/submit_classes.php" method="post">
						<div class="form-group">
							<label for="className">Class Name</label>
							<input type="text" class="form-control" id="className" name="className" aria-describedby="classHelp" placeholder="Enter class name" required>
