...
if (isset($_SESSION['userid']) && ($_SESSION['userstatus'] == 'ADMIN')) {
	...
	$navBrand = "View Users' Log";
	$range = 10;
	$offset = 0;
	$result = $con->query("SELECT * FROM users_log ORDER BY LOG_IN_TIME DESC;");
?>

<!doctype html>
<html lang="en">
	<head>
		<title>FMS | View Users' Log</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<div class="container-fluid mt-5">
			<div class="row px-5 mx-5">
				<table class="table table-bordered table-striped mt-3 bg-white table-sm">
					<caption class="lead">Users' log with log in and log out time.</caption>
