...
if (isset($_SESSION['userid']) && ($_SESSION['userstatus'] == 'ACCOUNTS')) {
	...
	$navBrand = 'Add Static Fee Heads';
?>

<!doctype html>
<html lang="en">
	<head>
		<title>FMS | Add Static Fee Heads</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<div class="container-fluid px-5">
			<div class="row pt-5">
				...
				<div class="col-lg-4 ml-sm-auto">
					<h3 class="form-banner" style="background-color: #5CB860;">Add Static Fee Heads</h3>
					<form class="px-3 py-3 form" action="../php/submit_static_heads.php" method="post">
						<div class="form-group">
							<label for="staticHeadName">Static Fee Head Name</label>
							<input type="text" class="form-control" id="staticHeadName" name="staticHeadName" aria-describedby="staticHeadHelp" placeholder="Enter static fee head name" required>
						...
						<button type="submit" class="btn btn-success btn-block">Add Static Fee Head</button>
